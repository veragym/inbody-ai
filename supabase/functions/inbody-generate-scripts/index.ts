...
- pre_inputs: { exercise_purpose[], exercise_experience, pain_concerns[], body_shape_concerns[], member_tendency, motivation_level, exercise_frequency, protein_intake, carb_intake, fat_intake }
...
Deno.serve(async (req) => {
  ...
  const { inbody_record_id, member_id, pre_inputs } = body;
